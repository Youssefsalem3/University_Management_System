...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(1170, 417);
			...
			this->label1->Location = System::Drawing::Point(17, 95);
			...
			// nameTextBox
			// 
			this->nameTextBox->Location = System::Drawing::Point(185, 100);
			...
			this->electiveCheckBox->Location = System::Drawing::Point(136, 449);
			this->electiveCheckBox->Name = L"electiveCheckBox";
			this->electiveCheckBox->Size = System::Drawing::Size(18, 17);
			this->electiveCheckBox->TabIndex = 3;
			this->electiveCheckBox->UseVisualStyleBackColor = true;
			// 
			// codeTextBox
			// 
			this->codeTextBox->Location = System::Drawing::Point(185, 160);
			...
			this->label3->Location = System::Drawing::Point(18, 217);
			...
			this->label4->Location = System::Drawing::Point(18, 286);
			...
			this->label5->Location = System::Drawing::Point(17, 361);
			...
			this->label6->Location = System::Drawing::Point(17, 440);
			...
			// maxStudentsTextBox
			// 
			this->maxStudentsTextBox->Location = System::Drawing::Point(185, 366);
			...
			// hoursTextBox
			// 
			this->hoursTextBox->Location = System::Drawing::Point(185, 291);
			...
			this->label7->Location = System::Drawing::Point(556, 97);
			...
			this->checkBox1->Location = System::Drawing::Point(561, 36);
			...
			this->button2->Location = System::Drawing::Point(1068, 101);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(140, 23);
			this->button2->TabIndex = 16;
			this->button2->Text = L"Add Prereq";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &AddCourse::button2_Click);
			// 
			// label12
			// 
			...
			this->label12->Size = System::Drawing::Size(297, 41);
			this->label12->TabIndex = 25;
			this->label12->Text = L"Add New Course";
			// 
			// AddCourse
			// 
			...
			this->ClientSize = System::Drawing::Size(1395, 510);
